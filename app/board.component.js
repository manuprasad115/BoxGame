...
var BoardComponent = (function () {
    ...
    BoardComponent.prototype.chainCount = function (_edge, _bid) {
        ...
        if (_edge != null) {
            ...
            var _boxes = void 0;
            if (_bid == 0) {
                _boxes = this.boxListByEdgeId(_edge.id).filter(function (b) { return b.getBlankEdges().length == 2; });
            }
            else {
                _boxes = this.boxListByEdgeId(_edge.id).filter(function (b) { return b.getBlankEdges().length == 2 && b.id != _bid; });
            }
